...
class Settings(BaseSettings):
    db_user: str = pydantic.Field(alias="db_user")
    db_password: str = pydantic.Field(alias="db_password")
    db_name: str = pydantic.Field(alias="db_name")
    db_host: str = pydantic.Field(alias="db_host")
    db_port: int = pydantic.Field(alias="db_port")
